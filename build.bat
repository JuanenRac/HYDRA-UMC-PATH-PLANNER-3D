...
echo.
echo *****************************************************************************
echo * HYDRA-UMC-PATH-PLANNER-3D - build.bat
...
copy /Y target\release\hydra-umc-path-planner-3d.exe build\hydra-umc-path-planner-3d.exe >nul

echo Build OK: build\hydra-umc-path-planner-3d.exe
endlocal
pause
