...
printf '\n*******************************************************************************\n'
printf '%s\n' "* HYDRA-UMC-PATH-PLANNER-3D - build.sh"
...
echo "=== HYDRA-UMC-PATH-PLANNER-3D build ==="
...
mkdir -p build
cp -f target/release/hydra-umc-path-planner-3d build/hydra-umc-path-planner-3d 2>/dev/null || \
    cp -f target/release/hydra-umc-path-planner-3d.exe build/hydra-umc-path-planner-3d.exe

echo "Build OK: build/hydra-umc-path-planner-3d"
