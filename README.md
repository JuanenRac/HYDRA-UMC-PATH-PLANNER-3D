...
│   ├── semantics.rs  # Shared semantic gate: rejects an invalid scenario before any geometry check
...
cargo test   # geometry + obstacle collision math, the PRNG, the RRT
             ...
             # failing-scenario minimization - 48 tests total
```
