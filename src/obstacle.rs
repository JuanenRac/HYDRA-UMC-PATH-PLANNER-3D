...
// else). An octree/BVH for large obstacle counts is real, deliberately
// deferred future work once there's a scene with enough obstacles for
// brute-force checking to actually matter - today's swarm cell is a
